...
START_TEST(round_t1) {
  s21_decimal a = {{0, 12345, 6789, 0}, S21_NORMAL},
              res = {{0, 12345, 6789, 0}, S21_NORMAL};
...
START_TEST(round_t2) {
  s21_decimal a = {{2147483648, 12345, 6789, 0}, S21_NORMAL},
              res = {{2147483648, 12345, 6789, 0}, S21_NORMAL};
  s21_decimal round_a = {0};
